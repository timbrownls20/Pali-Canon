...
namespace PaliCanon.Contracts.Quote
{
    ...
    {
        (T chapter, TU verse) Quote(string bookCode = null, int? maxLength = null);
        List<(T chapter, TU verse)> Quotes(int numberOfQuotes, string bookCode = null, int? maxLength = null);
